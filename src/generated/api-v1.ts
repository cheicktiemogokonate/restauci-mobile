...
export const apiV1Document = {
  ...
  "paths": {
    ...
    "/client/commandes/{id}/livraison": {
      "get": {
        "operationId": "getClientDelivery",
        "tags": [
          "Livraison consommateur"
        ],
        "summary": "Lire le suivi, le livreur et la preuve de remise",
        "parameters": [
          {
            "name": "id",
            "in": "path",
    ...
    "/client/commandes/{id}/livraison/confirmation": {
      "post": {
        "operationId": "confirmClientDelivery",
        "tags": [
          "Livraison consommateur"
        ],
        "summary": "Confirmer la remise depuis l'espace client",
        "parameters": [
          {
            "name": "id",
            "in": "path",
    ...
    "/livreur/auth/login": {
      "post": {
        ...
        "summary": "Connecter un livreur ou demander son activation",
        "security": [],
        "requestBody": {
          "required": true,
          "content": {
    ...
    "/livreur/auth/activation": {
      "post": {
        "operationId": "activateDriver",
        "tags": [
          "Auth livreur"
        ],
        "summary": "Choisir le mot de passe définitif",
        "security": [],
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/DriverActivationRequest"
              }
            }
          }
        },
    ...
    "/livreur/auth/refresh": {
      "post": {
        "operationId": "refreshDriver",
        "tags": [
          "Auth livreur"
        ],
        "summary": "Renouveler une session livreur",
        "security": [],
        "requestBody": {
          "required": true,
          "content": {
    ...
    "/livreur/auth/logout": {
      "post": {
        ...
        "summary": "Révoquer une session livreur",
        "security": [],
        "requestBody": {
          "required": true,
          "content": {
    ...
    "/livreur/me": {
      "get": {
        ...
        "summary": "Lire profil, disponibilité, espèces et rémunérations dues",
        "responses": {
          "200": {
            "description": "Succès",
            "content": {
    ...
    "/livreur/disponibilite": {
      "patch": {
        ...
        "summary": "Se déclarer disponible ou indisponible",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
    ...
    "/livreur/offres/courante": {
      "get": {
        "operationId": "getCurrentDriverOffer",
        "tags": [
          "Missions livreur"
        ],
        "summary": "Lire la proposition active",
        "responses": {
          "200": {
            "description": "Succès",
            "content": {
    ...
    "/livreur/offres/{id}/reponse": {
      "post": {
        "operationId": "respondDriverOffer",
        "tags": [
          "Missions livreur"
        ],
    ...
    "/livreur/livraisons": {
      "get": {
        "operationId": "listDriverDeliveries",
        "tags": [
          "Missions livreur"
        ],
        "summary": "Lister mission active et historique",
        "parameters": [
          {
            "name": "page",
            "in": "query",
    ...
    "/livreur/livraisons/{id}": {
      "get": {
        "operationId": "getDriverDelivery",
        "tags": [
          "Missions livreur"
        ],
        "summary": "Lire une mission appartenant au livreur",
        "parameters": [
          {
            "name": "id",
            "in": "path",
    ...
    "/livreur/livraisons/{id}/depart": {
      "post": {
        "operationId": "startDriverDelivery",
        "tags": [
          "Missions livreur"
        ],
        "summary": "Confirmer la récupération d'une commande prête",
        "parameters": [
          {
            "name": "id",
            "in": "path",
    ...
    "/livreur/livraisons/{id}/remise": {
      "post": {
        "operationId": "completeDriverDelivery",
        "tags": [
          "Missions livreur"
        ],
        "summary": "Confirmer preuve de remise et espèces",
        "parameters": [
          {
            "name": "id",
            "in": "path",
        ...
        "requestBody": {
          ...
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/CompleteDriverDeliveryRequest"
              }
            }
          }
        },
    ...
    "/livreur/livraisons/{id}/echec": {
      "post": {
        "operationId": "failDriverDelivery",
        "tags": [
          "Missions livreur"
        ],
        "summary": "Signaler un échec motivé",
        "parameters": [
          {
            "name": "id",
            "in": "path",
        ...
        "requestBody": {
          ...
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/FailDriverDeliveryRequest"
              }
            }
          }
        },
    ...
    "/livreur/notifications": {
      "get": {
        "operationId": "listDriverNotifications",
        "tags": [
          "Notifications livreur"
        ],
        "summary": "Lister les notifications livreur",
        "parameters": [
          {
            "name": "page",
            "in": "query",
      ...
      "patch": {
        "operationId": "markDriverNotificationsRead",
        "tags": [
          "Notifications livreur"
        ],
        "summary": "Marquer les notifications livreur comme lues",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
    ...
    "/livreur/push/expo": {
      "post": {
        "operationId": "registerDriverExpoToken",
        "tags": [
          "Notifications livreur"
        ],
        "summary": "Associer une installation Expo au livreur",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
      ...
      "delete": {
        "operationId": "unregisterDriverExpoToken",
        "tags": [
          "Notifications livreur"
        ],
        "summary": "Dissocier une installation Expo du livreur",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
    ...
    "/public/restaurants/search": {
      "post": {
        "operationId": "searchPublicRestaurants",
        "tags": [
          "Restaurants publics"
        ],
        "summary": "Rechercher les restaurants publiés",
        "security": [],
        "requestBody": {
          "required": true,
          "content": {
    ...
    "/public/discovery/mood": {
      "post": {
        "operationId": "searchPublicMood",
        "tags": [
          "Découverte"
        ],
        "summary": "Rechercher par ambiance et envie multi-verticales",
        "security": [],
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/MoodSearchRequest"
              }
            }
          }
        },
    ...
    "/public/etablissements/search": {
      "post": {
        "operationId": "searchPublicEtablissements",
        "tags": [
          "Découverte"
        ],
        "summary": "Rechercher les établissements unifiés sur la carte",
        "security": [],
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/EtablissementSearchRequest"
              }
            }
          }
        },
    ...
    "/restaurateur/commandes/{id}/livraison/assignation": {
      "get": {
        "operationId": "getRestaurantDelivery",
        "tags": [
          "Livraisons restaurant"
        ],
        "summary": "Lire la livraison et son journal",
        "parameters": [
          {
            "name": "id",
            "in": "path",
      ...
      "put": {
        "operationId": "proposeRestaurantDelivery",
        "tags": [
          "Livraisons restaurant"
        ],
        "summary": "Proposer la livraison à un livreur disponible",
        "parameters": [
          {
            "name": "id",
            "in": "path",
        ...
        "requestBody": {
          ...
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/ProposeDeliveryRequest"
              }
            }
          }
        },
      ...
      "delete": {
        "operationId": "unassignRestaurantDelivery",
        "tags": [
          "Livraisons restaurant"
        ],
        "summary": "Désassigner avant récupération",
        "parameters": [
          {
            "name": "id",
            "in": "path",
    ...
    "/restaurateur/livreurs": {
      "get": {
        "operationId": "listRestaurantDrivers",
        "tags": [
          "Flotte restaurant"
        ],
        "summary": "Lister la flotte et sa disponibilité réelle",
        "responses": {
          "200": {
            "description": "Succès",
            "content": {
      ...
      "post": {
        "operationId": "createRestaurantDriver",
        "tags": [
          "Flotte restaurant"
        ],
        "summary": "Créer un livreur et ses accès temporaires",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/RestaurantDriverRequest"
              }
            }
          }
        },
    ...
    "/restaurateur/livreurs/{id}": {
      "get": {
        "operationId": "getRestaurantDriver",
        "tags": [
          "Flotte restaurant"
        ],
        "summary": "Lire un livreur du restaurant",
        "parameters": [
          {
            "name": "id",
            "in": "path",
      ...
      "patch": {
        "operationId": "updateRestaurantDriver",
        "tags": [
          "Flotte restaurant"
        ],
        "summary": "Modifier un livreur du restaurant",
        "parameters": [
          {
            "name": "id",
            "in": "path",
        ...
        "requestBody": {
          ...
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/RestaurantDriverUpdateRequest"
              }
            }
          }
        },
    ...
    "/restaurateur/livreurs/{id}/acces": {
      "post": {
        "operationId": "resetDriverAccess",
        "tags": [
          "Flotte restaurant"
        ],
        "summary": "Régénérer les accès et révoquer les sessions",
        "parameters": [
          {
            "name": "id",
            "in": "path",
    ...
    "/restaurateur/livreurs/{id}/desactivation": {
      "post": {
        "operationId": "deactivateRestaurantDriver",
        "tags": [
          "Flotte restaurant"
        ],
        "summary": "Désactiver le compte et traiter sa mission",
        "parameters": [
          {
            "name": "id",
            "in": "path",
    ...
    "/restaurateur/livreurs/{id}/remises-especes": {
      "post": {
        "operationId": "confirmDriverCashRemittance",
        "tags": [
          "Espèces livreur"
        ],
        "summary": "Confirmer la remise exacte d'un lot d'encaissements",
        "parameters": [
          {
            "name": "id",
            "in": "path",
        ...
        "requestBody": {
          ...
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/CashRemittanceRequest"
              }
            }
          }
        },
    ...
    "/restaurateur/livreurs/{id}/remunerations": {
      "post": {
        "operationId": "confirmDriverCompensationPayment",
        "tags": [
          "Rémunérations livreur"
        ],
        "summary": "Déclarer réglées les rémunérations dues du livreur",
        "parameters": [
          {
            "name": "id",
            "in": "path",
        ...
        "requestBody": {
          ...
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/DriverCompensationPaymentRequest"
              }
            }
          }
        },
  ...
  "components": {
    ...
    "schemas": {
      ...
      "DriverCompensationPaymentRequest": {
        "type": "object",
        "additionalProperties": false,
        "properties": {
          "note": {
        ...
        "description": "Déclare réglées toutes les rémunérations actuellement dues. RestauCI ne transfère aucun fonds."
      },
