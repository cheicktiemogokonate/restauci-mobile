  ...
  return (
    <>
      ...
      <SafeAreaView className="flex-1">
        <View className="flex-row items-center justify-between px-4 py-3"><Pressable onPress={() => router.back()} className="h-10 w-10 items-center justify-center rounded-full bg-white"><ChevronLeft color="theme.ink900" /></Pressable><Text className="text-xl font-extrabold text-ink-900">Notifications</Text><View className="w-10" /></View>
